...
const CustomerManagement2 = () => {
  ...
  const handleEditSubmit = (values) => {
    // Note: Local table update is disabled because tableData is computed from RTK Query response.
    // TODO: Implement and dispatch updateCustomer mutation when backend endpoint is ready.
    setIsEditModalVisible(false);
    form.resetFields();
